class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    appMinimumVersionAndroid =
        json['app_minimum_version_android_deliveryman'] != null
        ? json['app_minimum_version_android_deliveryman']?.toDouble()
        : 0.0;
    appUrlAndroid = json['app_url_android_deliveryman'];
    appMinimumVersionIos = json['app_minimum_version_ios_deliveryman'] != null
        ? json['app_minimum_version_ios_deliveryman']?.toDouble()
        : 0.0;
    ...
    parcelMinimumShippingCharge = json['parcel_minimum_shipping_charge']
        ?.toDouble();
    dmPictureUploadStatus = json['dm_picture_upload_status'] == 1
        ? true
        : false;
    ...
    parcelCancellationBasicSetup =
        json['parcel_cancellation_basic_setup'] != null
        ? ParcelCancellationBasicSetup.fromJson(
            json['parcel_cancellation_basic_setup'],
          )
        : null;
    parcelReturnTimeFee = json['parcel_return_time_fee'] != null
        ? ParcelReturnTimeFee.fromJson(json['parcel_return_time_fee'])
        : null;
    dmLoyalityPointData = json['dm_loyality_point_data'] != null
        ? LoyalityPointData.fromJson(json['dm_loyality_point_data'])
        : null;
    riderLoyalityPointData = json['rider_loyality_point_data'] != null
        ? LoyalityPointData.fromJson(json['rider_loyality_point_data'])
        : null;
    dmReferralData = json['dm_referral_data'] != null
        ? ReferralData.fromJson(json['dm_referral_data'])
        : null;
    ...
    vehicleTransmissionTypes = json['vehicle_transmission_types'] != null
        ...
        : [];
    safetyFeatureStatus = int.tryParse(
      json['safety_feature_status'].toString(),
    );
    safetyFeatureMinimumTripDelayTime = json['ride_safety_delay_time'];
    safetyFeatureMinimumTripDelayTimeType =
        json['ride_safety_delay_time_format'];
    afterTripCompleteSafetyFeatureSetTime = int.tryParse(
      json['safety_feature_after_ride_complete_time'].toString(),
    );
    safetyFeatureEmergencyGovtNumber = json['emergency_govt_number'];
    bidOnFare = int.tryParse(json['bid_on_fare'].toString());
    otpConfirmationForTrip = int.tryParse(
      json['ride_otp_confirmation'].toString(),
    );
    ...
    if (json['rider_completion_radius'] != null) {
      try {
        ...
        completionRadius = double.parse(
          json['rider_completion_radius'].toString(),
        );
      }
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (parcelCancellationBasicSetup != null) {
      data['parcel_cancellation_basic_setup'] = parcelCancellationBasicSetup!
          .toJson();
    }
...
class ParcelCancellationBasicSetup {
  ...
  ParcelCancellationBasicSetup({
    this.returnFeeStatus,
    this.returnFee /*this.doNotChargeReturnFeeOnDeliverymanCancel*/,
  });
...
class LoyalityPointData {
  ...
  LoyalityPointData({
    this.loyalityPointStatus,
    this.loyalityPointConversionRate,
    this.minLoyalityPointToConvert,
  });
