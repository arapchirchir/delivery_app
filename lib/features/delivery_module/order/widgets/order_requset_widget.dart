...
import 'package:letsy_delivery/features/delivery_module/order/screens/order_location_screen.dart';
...
class OrderRequestWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool prescription = orderModel.prescriptionOrder ?? false;
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
              ...
              Expanded(
                child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  (showEarning && Get.find<ProfileController>().profileModel != null
