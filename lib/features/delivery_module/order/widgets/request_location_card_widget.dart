...
class RequestLocationCardWidget extends StatelessWidget {
  final OrderModel orderModel;
  final OrderController orderController;
  const RequestLocationCardWidget({super.key, required this.orderModel, required this.orderController});
  ...
  Widget build(BuildContext context) {
    ...
    bool showEarning = isRideActive ? (config?.showRiderEarning ?? false) : (config?.showDmEarning ?? false);
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(
              DateConverterHelper.timeDistanceInMin(orderModel.createdAt!),
        ...
        Center(
          child: Padding(
            ...
            child: Wrap(alignment: WrapAlignment.center, runAlignment: WrapAlignment.center, children: [
              ...
              (showEarning && Get.find<ProfileController>().profileModel!.earnings == 1) ? Text(
              ...
              child: Row(children: [
                ...
                Expanded(child: CustomButtonWidget(
                  ...
                  onPressed: () => Get.dialog(ConfirmationDialogWidget(
                    ...
                    onYesPressed: () {
                      orderController.acceptOrder(orderModel.id, -1, orderModel).then((isSuccess) {
                        if(isSuccess) {
