...
import 'package:letsy_delivery/common/widgets/custom_app_bar_widget.dart';
import 'package:letsy_delivery/common/widgets/custom_image_widget.dart';
import 'package:letsy_delivery/features/chat/domain/models/conversation_model.dart';
import 'package:letsy_delivery/features/delivery_module/order/controllers/order_controller.dart';
import 'package:letsy_delivery/features/delivery_module/order/domain/models/order_details_model.dart';
import 'package:letsy_delivery/features/delivery_module/order/domain/models/order_model.dart';
import 'package:letsy_delivery/features/delivery_module/order/widgets/bottom_view/parcel_bottom_view.dart';
import 'package:letsy_delivery/features/delivery_module/order/widgets/bottom_view/regular_order_bottom_view.dart';
import 'package:letsy_delivery/features/delivery_module/order/widgets/info_card_widget.dart';
import 'package:letsy_delivery/features/delivery_module/order/widgets/order_item_widget.dart';
import 'package:letsy_delivery/features/notification/domain/models/notification_body_model.dart';
import 'package:letsy_delivery/features/splash/controllers/splash_controller.dart';
import 'package:letsy_delivery/helper/date_converter_helper.dart';
import 'package:letsy_delivery/helper/price_converter_helper.dart';
import 'package:letsy_delivery/helper/responsive_helper.dart';
import 'package:letsy_delivery/helper/route_helper.dart';
import 'package:letsy_delivery/helper/string_extension.dart';
import 'package:letsy_delivery/util/app_constants.dart';
import 'package:letsy_delivery/util/dimensions.dart';
import 'package:letsy_delivery/util/styles.dart';
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: GetBuilder<OrderController>(builder: (orderController) {
            ...
            double deliveryFeeReductionAmount = 0;
            ...
            if(order != null && orderController.orderDetailsModel != null) {
              ...
              deliveryFeeReductionAmount = order.deliveryFeeReductionAmount ?? 0;
              if (order.benefitType == 'discount') {
                benefitAmount = proDiscount;
              } else if (order.benefitType == 'delivery_fee') {
                if (order.deliveryOfferType == 'full_free') {
                  benefitAmount = deliveryCharge ?? 0;
                } else if (order.deliveryOfferType == 'partial_free') {
                  benefitAmount = deliveryFeeReductionAmount;
                }
              }
                  ...
                  Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      couponDiscount > 0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text(order.benefitType == 'coupon' ? 'pro_coupon_discount'.tr : 'coupon_discount'.tr, style: robotoRegular),
                        Text(
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text(order.benefitType == 'delivery_fee'? 'pro_delivery_fee'.tr : 'delivery_fee'.tr, style: robotoRegular),
                        Text('(+) ${PriceConverterHelper.convertPrice(deliveryCharge)}', style: robotoRegular),
                      ]),
                      const SizedBox(height: 10),

                      order.benefitType == 'discount' && proDiscount > 0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text('pro_discount'.tr, style: robotoRegular),
                        Text('(-) ${PriceConverterHelper.convertPrice(proDiscount)}', style: robotoRegular),
                      ]) : const SizedBox(),
                      SizedBox(height: order.benefitType == 'discount' && proDiscount > 0 ? 10 : 0),
                      ...
                      (order.deliveryType != null && order.deliveryTypeCharge != null && order.deliveryTypeCharge! > 0) ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Expanded(
                          child: Text(order.deliveryType == 'slightly_delay' ? 'slightly_delay_delivery'.tr : 'express_delivery'.tr, style: robotoRegular, maxLines: 1, overflow: TextOverflow.ellipsis),
                        ),
                        SizedBox(width: Dimensions.paddingSizeSmall),

                        Text('${order.deliveryType == 'slightly_delay' ? '(-)' : '(+)'} ${PriceConverterHelper.convertPrice(order.deliveryTypeCharge)}', style: robotoRegular, textDirection: TextDirection.ltr),
                      ]) : const SizedBox(),
